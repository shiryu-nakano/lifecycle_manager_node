...
std::optional<TransitionRecipe> StoppingToPurePursuitHandler::handle(const TransitionContext& ctx)
{
...
StoppingToInplaceTurnHandler::StoppingToInplaceTurnHandler(double timeout)
    : timeout_(timeout) {}

std::optional<TransitionRecipe> StoppingToInplaceTurnHandler::handle(const TransitionContext& ctx)
{
